...
export const ar: Dictionary = {
  ...
  pricing: {
    ...
    period: "سنوياً",
    description: "دفعة سنوية واحدة للوصول المميز عبر الدفع من الموقع عند تفعيله.",
    features: [
      "تحليل صور الطعام بالذكاء الاصطناعي",
      "تسجيل الوجبات نصياً أو يدوياً أو بالصوت",
      "تتبع التقدم والماكروز فقط",
    ],
    cta: "اشترك الآن",
